...
import co.jp.mamol.myapp.service.CAPTCHAService;
...
@Results({@Result(name = "login", location = "/WEB-INF/jsp/login.jsp"),
    ...
    @Result(name = "scanner", location = "/qrScanner/init", type = "redirect")})
...
public class LoginAction extends BaseAction {
  ...
  public String login() {
    ...
    if (userDto.getRole_class().equals("1")) {
      ...
      return "order";
    } else if (userDto.getRole_class().equals("6")) {
      return "scanner";
    } else {
      return "error";
    }
